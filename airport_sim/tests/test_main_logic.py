...
class TestSimulationInitialization:
    ...
    def test_simulation_created(self):
        ...
        sim = SimulationController(10, 10, 3, 1, 1, 1, 30)
...
class TestRunwayGeneration:
    ...
    def test_runways_generated_correctly(self):
        ...
        sim = SimulationController(10, 10, 5, 2, 2, 1, 30)
        assert len(sim.runway_list) == 5
    
    def test_departure_runways_generated(self):
        """Test departure runways created"""
        sim = SimulationController(10, 10, 3, 2, 1, 0, 30)
        departure_count = sum(1 for r in sim.runway_list if r.is_departure and not r.mixed_mode)
...
class TestPlaneGeneration:
    ...
    def test_generate_departure_plane(self):
        ...
        assert sim.report.total_planes == 1
